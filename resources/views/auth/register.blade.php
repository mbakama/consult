                               ...
                               <input id="name" type="text"
                                ...
                                <div class="mb-3">
                                        ...
                                        <input id="email" type="email"
                                            ...
                                            value="{{ old('email') }}" placeholder="inserer ton email" required autocomplete="email">
                                ...
                                {{-- <div class="mb-3">
                                    ...
                                    <input id="email" type="email"
                                        class="form-control @error('email') is-invalid @enderror" name="email"
                                        value="{{ old('email') }}" placeholder="entrer votre email"  autocomplete="email">
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input id="password" type="password"
                                            class="form-control @error('password') is-invalid @enderror" name="password"
                                             placeholder="entrer votre mot de pass" autocomplete="new-password">
                                ...
                                <div class="mb-3"> 
                                    <div class="input-group input-group-merge">
                                        <input id="password-confirm" placeholder="confirmer password" type="password" class="form-control" name="password_confirmation" autocomplete="new-password"> 
                                     </div> 
                                    </div>
                                <div class="mb-3">
