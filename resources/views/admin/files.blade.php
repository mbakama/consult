                        ...
                        <div class="card-body">
                            ...
                            <div class="page-aside-left">
                                ...
                                <div class="btn-group d-block mb-2">
                                    <button type="button" class="btn btn-success dropdown-toggle w-100" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i><iconify-icon icon="mdi:plus"></iconify-icon></i> Create New </button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#"><i class="me-1"><iconify-icon icon="mdi:folder-plus-outline"></iconify-icon></i> Folder</a>
                                        <a class="dropdown-item" href="#"><i class="me-1"><iconify-icon icon="mdi:file-plus-outline"></iconify-icon></i> File</a>
                                        <a class="dropdown-item" href="#"><i class="me-1"><iconify-icon icon="mdi:file-document"></iconify-icon></i> Document</a>
                                        <a class="dropdown-item" href="#"><i class="me-1"><iconify-icon icon="mdi:upload"></iconify-icon></i> Choose File</a>
                                    </div>
                                </div>
                                <div class="email-menu-list mt-3">
                                    <a href="#" class="list-group-item border-0"><i class="font-18 align-middle me-2"><iconify-icon icon="mdi:folder-outline"></iconify-icon></i> My Files</a>
                                    <a href="#" class="list-group-item border-0"><i class="font-18 align-middle me-2"><iconify-icon icon="mdi:google-drive"></iconify-icon></i>Google Drive</a>
                                    <a href="#" class="list-group-item border-0"><i class="font-18 align-middle me-2"><iconify-icon icon="mdi:dropbox"></iconify-icon></i>Dropbox</a>
                                    <a href="#" class="list-group-item border-0"><i class="font-18 align-middle me-2"><iconify-icon icon="mdi:share-variant"></iconify-icon></i>Share with me</a>
                                    <a href="#" class="list-group-item border-0"><i class="font-18 align-middle me-2"><iconify-icon icon="mdi:clock-outline"></iconify-icon></i>Recent</a>
                                    <a href="#" class="list-group-item border-0"><i class=" font-18 align-middle me-2"><iconify-icon icon="mdi:star-outline"></iconify-icon></i>Starred</a>
                                    <a href="#" class="list-group-item border-0"><i class="font-18 align-middle me-2"><iconify-icon icon="mdi:delete"></iconify-icon></i>Deleted Files</a>
                                </div>
                            ...
                            <div class="page-aside-right">
                                ...
                                <div class="d-lg-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <button type="submit" class="btn btn-sm btn-light"><i><iconify-icon icon="mdi:format-list-bulleted"></iconify-icon></i></button>
                                        <button type="submit" class="btn btn-sm"><i><iconify-icon icon="mdi:view-grid"></iconify-icon></i></button>
                                        <button type="submit" class="btn btn-sm"><i><iconify-icon icon="mdi:information-outline"></iconify-icon></i></button>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="col-auto">
                                                            <div class="avatar-sm">
                                                                <span class="avatar-title bg-light text-secondary rounded">
                                                                    <i class="font-16"><iconify-icon icon="mdi:folder-zip"></iconify-icon></i>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="col ps-0">
                                                ...
                                                <div class="p-2">
                                                    <div class="row align-items-center">
                                                        <div class="col-auto">
                                                            <div class="avatar-sm">
                                                                <span class="avatar-title bg-light text-secondary rounded">
                                                                    <i class="font-16"><iconify-icon icon="mdi:folder"></iconify-icon></i>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="col ps-0">
                                                        ...
                                                        <div class="col-auto">
                                                            <div class="avatar-sm">
                                                                <span class="avatar-title bg-primary-lighten text-primary rounded">
                                                                    <i class="font-16"><iconify-icon icon="mdi:folder-zip-outline"></iconify-icon></i>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="col ps-0">
                                                ...
                                                <div class="p-2">
                                                    <div class="row align-items-center">
                                                        <div class="col-auto">
                                                            <div class="avatar-sm">
                                                                <span class="avatar-title bg-light text-secondary rounded">
                                                                    <i class="font-16"><iconify-icon icon="mdi:file-pdf-box"></iconify-icon></i>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="col ps-0">
                                                        ...
                                                        <div class="col-auto">
                                                            <div class="avatar-sm">
                                                                <span class="avatar-title bg-light text-secondary rounded">
                                                                    ...
                                                                    <i class="font-18"><iconify-icon icon="mdi:folder-account"></iconify-icon></i>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="col ps-0">
                                                    ...
                                                    <td class="">
                                                        <div class="btn-group dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <a class="dropdown-item" href="#"><i class="me-2 text-muted vertical-middle"><iconify-icon icon="mdi:pencil"></iconify-icon></i>Rename</a>
                                                                <a class="dropdown-item" href="#"><i class="me-2 text-muted vertical-middle"><iconify-icon icon="mdi:download"></iconify-icon></i>Download</a>
                                                                <a class="dropdown-item" href="#"><i class="me-2 text-muted vertical-middle"><iconify-icon icon="mdi:delete"></iconify-icon></i>Remove</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
